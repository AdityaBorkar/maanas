...
export default function InputArray(props: ArrrayInputProps) {
	...
	return (
		<div className={props.wrapperClass}>
			<h4 className='text-text-4 relative mb-4 border-b-2 py-3 font-semibold uppercase tracking-widest'>
				<Button
					className='text-text-4 absolute right-0 top-2 w-fit bg-neutral-100 text-xs'
					onClick={() => append({})}
					color='custom'
				>
					Add {LABEL}
