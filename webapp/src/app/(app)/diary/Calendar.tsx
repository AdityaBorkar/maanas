...
export default function Calendar(props: {
	...
	return (
		<div className={twMerge('mx-auto h-fit w-fit', props.className)}>
			...
			<div className='mx-auto grid w-fit grid-flow-row grid-cols-[repeat(7,minmax(0,1fr))] gap-1 text-sm'>
				{CALENDAR.map((day) => {
					...
					return (
						<Link
							...
							className={twMerge(
								'flex size-10 items-center justify-center rounded-md bg-neutral-950 text-neutral-500',
