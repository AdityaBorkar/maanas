		...
		<div className='relative ml-20 grid grid-cols-1'>
			{days.map((day, index) => (
				<div className='relative min-h-[35px]' key={index}>
					<div className='absolute -left-28 -top-2 w-24 text-right text-sm font-medium text-neutral-500'>
						{8 + index}:00 AM
					</div>
...
function DayTimeline2() {
	...
	return (
		<div className='mt-8'>
			<div className='text-text-3 hover:text-text-1 cursor-pointer border-b border-neutral-800 px-2 pb-3 text-2xl font-medium'>
				May 31, 2023
			</div>
